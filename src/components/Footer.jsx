        ...
        <section className="newletter">
          <div className="grid grid-cols-1 lg:grid-cols-2 px-6 lg:px-10 lg:items-center">
            ...
            <motion.div
              ...
              className=" bg-white flex items-center h-10 py-7"
            >
              <input
                type="text"
          ...
          <div className="px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-4 lg:gap-16 items-center">
            ...
            >
              <img
                src={Logo}
                alt="logo"
                className="w-32 block mx-auto lg:mx-0"
              />
            ...
            <motion.div
              ...
              className="lg:pl-20 text-center lg:text-left"
            >
